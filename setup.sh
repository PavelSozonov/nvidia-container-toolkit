...
# setup.sh - Creates a README.md file for NVIDIA Container Toolkit offline installation
...
if [ -f "$README_FILE" ]; then
    echo "Error: $README_FILE already exists in this directory."
...
echo "Successfully created $README_FILE"
exit 0